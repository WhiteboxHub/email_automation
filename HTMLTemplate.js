...
// Email-project-org/HTMLTemplate.js
const htmlTemplate = (name, experience, skill, location, visa, resumeLink, phone, linkedin, email) => `
  <p>Hello,</p>
  <p>Hope you are doing great.</p>
  <p>I am ${name}, experienced in ${skill} with ${experience}. I am excited to share my profile with you. I have work authorization and am ready to contribute. I am available for <strong style="color:darkblue">C2C and C2H opportunities</strong>.</p>
  <p>I do not require visa sponsorship as I hold a <strong style="color:darkblue">${visa} status</strong>.</p>
  <p>If my profile aligns with your current needs, please don't hesitate to reach out. Additionally, I would appreciate it if you could add my email to your daily distribution list:
